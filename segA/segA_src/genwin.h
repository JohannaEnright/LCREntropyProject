...
struct Alphabet
  {
   ...
   int symsize[128]; // # of chars refered to by this symbol
   int symweight[128]; // composition weight for this symbol
   char *symindicies[128]; // array of char indicies to which this symbol maps

   int index[128]; // index of characters
};
...
extern struct Alphabet *openabet();
extern closeabet();
...
extern upper(), lower(), findchar(), gcd(), lcm();
